...
public class MainActivity extends Activity {
    ...
    protected void onResume() {
        ...
        System.out.println("cls:"+inflate.findViewById(R.id.test).getClass()+"  "+inflate.findViewById(R.id.test).getClass().getClassLoader());
    }
...
//        startActivity(new Intent(this, LiveMainActivity.class));
    ...
    public void testProcessMainActivity(View view) {
